  ...
  const fetchPage = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: 'Error',
          description: data.error || 'Failed to fetch page',
          variant: 'destructive',
        });
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: 'Error',
          description: data.error || 'Failed to update page',
          variant: 'destructive',
        });
      }
    } catch (error) {
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-4">Edit Page</h1>
